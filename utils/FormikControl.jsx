          ...
          return (
            <Select
              ...
              onChange={({ value }) => {
                ...
                if (changeFunc) changeFunc(value);
              }}
            />
          );
        }}
...
function Input(props) {
  const { label, name, style, grid, ...rest } = props;
  return (
    <div
      className={`formik-control formik-control-${name.replace(regex, "-")} ${
        grid ?? ""
...
function RadioButtons(props) {
  const { label, name, style, options, grid, ...rest } = props;
  return (
    <div
      className={`formik-control formik-control-${name.replace(regex, "-")} ${
        grid ?? ""
...
function CheckBoxes(props) {
  const { label, style, name, options, grid, ...rest } = props;
  return (
    <div
      className={`formik-control formik-control-${name.replace(regex, "-")} ${
        grid ?? ""
...
function DatePicker(props) {
  const { label, style, name, grid, ...rest } = props;
  return (
    <div
      className={`formik-control formik-control-${name.replace(regex, "-")} ${
        grid ?? ""
